...
class Logger {
	...
	devlog(...args) {
		this.print(LogCode.info, 1, ...args);
	}

	log(...args) {
		this.print(LogCode.info, 2, ...args);
	}

	devwarn(...args) {
		this.print(LogCode.warn, 2, ...args);
	}

	warn(...args) {
		this.print(LogCode.warn, 3, ...args);
	}

	deverror(...args) {
		this.print(LogCode.error, 3, ...args);
	}

	error(...args) {
		this.print(LogCode.error, 4, ...args);
	}
